        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <div style={{ backgroundColor: '#0d0d12', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '32px', padding: '32px' }}>
             ...
             <button 
                ...
                style={{ width: '100%', backgroundColor: paymentMethod === 'balance' ? '#ff00f2' : '#00f2ff', color: '#000', padding: '18px', borderRadius: '16px', fontWeight: '900', fontSize: '16px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px', marginBottom: '16px', boxShadow: paymentMethod === 'balance' ? '0 0 30px rgba(255, 0, 242, 0.2)' : '0 0 30px rgba(0, 242, 255, 0.2)' }}
              >
